...
| F_ID | Feature | Product |
|------|---------|---------|
| F01 | Kiosk Lockdown Mode | Aster Device Manager |
| F02 | Remote Wipe & Lock | Aster Device Manager |
| F03 | Zero-Touch Enrollment | Aster Device Manager |
| F04 | High-Speed Barcode Engine | Aster Scan Suite |

### Existing pain points
| P_ID | Pain Point | Cluster |
|------|------------|---------|
| P01 | Device operation in cold-storage and outdoor conditions | Environmental |
| P02 | Unauthorized use of company devices | Security |
| P03 | Slow, error-prone manual data entry | Operations |
| P04 | Device loss and data exposure | Security |
| P05 | Long onboarding time for seasonal staff | Operations |

### Existing verticals
| V_ID | Vertical |
|------|----------|
| V01 | Warehousing & Logistics |
| V02 | Field Services |

## Target catalogue file

Propose new features into `_data/features/aster_scan_suite.md`. If a proposed feature belongs to a different product, say so instead of forcing it into this file.
Route anything with no existing owner to reviewer `PM02`.

## Source document

Filename: aster_scan_analytics_notes.md
