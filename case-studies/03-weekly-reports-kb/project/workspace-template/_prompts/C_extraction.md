...
3. The team roster (CONTROLLING FILE — the single definition of who is on the
   team): <path to your organization's own roster, set this before your first run>
   If your roster lists nicknames or short forms next to full names, treat a
   nickname as an alias of the name it follows.
